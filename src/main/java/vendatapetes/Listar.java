...
public class Listar extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jCheckBox2.setText("Sobrenome");

        jCheckBox3.setText("CPF");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        result.add(jTextField1.getText());
        result.add(String.valueOf(jCheckBox1.isSelected()));
        result.add(String.valueOf(jCheckBox2.isSelected()));
        result.add(String.valueOf(jCheckBox3.isSelected()));
